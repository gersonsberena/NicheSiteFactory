...
export default function Toast({ show, onDismiss }: { show: boolean; onDismiss: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-4 px-6 py-4"
      style={{ background: "var(--accent)", boxShadow: "0 4px 20px rgba(0,0,0,0.15)" }}>
      <p className="text-[14px] font-semibold" style={{ color: "white", fontFamily: "DM Sans, sans-serif" }}>Message sent — we&rsquo;ll be in touch.</p>
